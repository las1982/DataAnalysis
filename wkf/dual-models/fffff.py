...
# db
tags = ["invoice_amount", "invoice_invoicee", "invoice_currency", "invoice_invoicee_address", "invoice_iban", "invoice_number", "invoice_swift", "invoice_bank_name", "invoice_bank_account_number", "invoice_date", "vendor_name"]
# hpe
# tags = ["bank_account_number", "bill_to_name", "invoice_amount", "invoice_currency", "invoice_date", "invoice_number", "invoice_order_number", "vendor_bank_account", "vendor_city", "vendor_country", "vendor_name", "vendor_state", "vendor_street", "vendor_zip"]
